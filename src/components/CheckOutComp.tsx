...
//                 .Buttons({
//                     createOrder: async () => {
//                         // auto save latest customer details before creating order
...
//                             const res = await fetch(`${import.meta.env.VITE_REACT_APP_API_BASE_URL}/api/paypal/complete`, {
//                                 method: 'POST',
//                                 headers: { 'Content-Type': 'application/json' },
//                                 body: JSON.stringify({
...
//                                 <th className="p-4">Product Img</th>
    ...
    useEffect(() => {
        ...
        const renderPayPalButtons = () => {
            ...
            (window as any).paypal
                .Buttons({
                    createOrder: async () => {
                        // Save latest customer details into Redux just in case
                        dispatch(setCustomerDetails(customerDetails as any));
