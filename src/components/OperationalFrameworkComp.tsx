...
const OperationalFrameworkComp = () => {
  ...
  return (
    <div className="w-full bg-white mt-25 text-white py-20 px-6 flex flex-col gap-20">
      ...
      {/* Section 1 */}
      <div
        className="w-[90%] mx-auto bg-white text-black shadow-xl rounded-2xl p-10 flex flex-col justify-center items-center text-center gap-6"
      ...
      {/* Section 3 */}
      <div
        className="w-[90%] mx-auto bg-white text-black shadow-xl rounded-2xl p-10 flex flex-col lg:flex-row-reverse justify-between items-center gap-10"
