...
//         smsConsent: Yup.boolean().oneOf([true], 'You must consent to receive SMS notifications'),
//         marketingConsent: Yup.boolean().oneOf([true], 'You must agree to receive occasional marketing messages'),
//     })

//     const handleSubmit = async (values: any, { resetForm, setSubmitting }: { resetForm: any, setSubmitting: any }) => {
//         try {
...
//                     <h2 className="text-3xl font-bold text-center text-[#ff4655] mb-8">Get In Touch</h2>
...
//                                     <Field name="phone" placeholder="(555) 123-4567" className="p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff4655]" />
...
//                                         <Field type="checkbox" name="smsConsent" className="mt-1" />
//                                         <span className="text-xs text-gray-700">
//                                             I Consent to Receive SMS Notifications, Alerts from <strong>Realtors Match</strong>. Message frequency varies. Message &amp; Data rates may apply. Text Help to <strong>(830) 468-9292</strong> for assistance. You can reply STOP to Unsubscribe at any time.
//                                         </span>
//                                     </label>
//                                     <ErrorMessage name="smsConsent" component="div" className="text-red-500 text-xs mt-1" />
//                                 </div>
//                                 {/* Marketing Consent Checkbox */}
//                                 <div className="flex flex-col md:col-span-2">
//                                     <label className="inline-flex items-start gap-2 mt-2">
//                                         <Field type="checkbox" name="marketingConsent" className="mt-1" />
//                                         <span className="text-xs text-gray-700">
//                                             By checking this box I agree to receive occasional marketing messages from <strong> Realtors Match.</strong>
//                                         </span>
//                                     </label>
//                                     <ErrorMessage name="marketingConsent" component="div" className="text-red-500 text-xs mt-1" />
//                                 </div>
...
//                                         className="text-xs text-gray-600 underline hover:text-[#ff4655] transition-colors"
//                                     >
//                                         Privacy Policy
//                                     </a>
//                                     <a
...
const ContactUsComp = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Basic validation (HTML5 also handles some)
        // if (!formData.firstName.trim() || !formData.lastName.trim() || !formData.email.trim() || !formData.phone.trim()) {
        //     alert('Please fill in all required fields.')
        //     return
        // }
        // if (!formData.smsConsent) {
        //     alert('You must consent to receive SMS notifications.')
        //     return
        // }
        // if (!formData.marketingConsent) {
        //     alert('You must agree to receive occasional marketing messages.')
        //     return
        // }

        try {
            setIsSubmitting(true)
            await axios.post(`${import.meta.env.VITE_REACT_APP_API_BASE_URL}/api/mail/contact`, formData)
            alert('Your message has been sent successfully!')
            setFormData({
                firstName: '',
                lastName: '',
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            placeholder="John"
                            // required
                            className="p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff4655]"
                        />
                    </div>
                    <div className="flex flex-col">
                        <label className="text-sm font-medium mb-1">Last Name</label>
                    ...
                    <div className="md:col-span-2 text-center">
                        <button
                            ...
                            className="bg-[#ff4655] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#e03e4c] transition-all duration-300"
                        >
                            {isSubmitting ? 'Submitting...' : 'Submit'}
                        </button>
                    </div>
