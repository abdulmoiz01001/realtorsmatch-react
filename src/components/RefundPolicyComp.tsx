  ...
  return (
    ...
    <div className='w-full h-full flex flex-col pt-30 justify-center items-center ' >
        <div className='bg-black w-[80%] py-10 flex flex-col justify-start items-start gap-8' >
           <h1 className='text-8xl text-[rgb(255,70,85)] font-semibold px-10 pt-10' >Refund Policy</h1>
        </div>
      ...
      <h2 className="text-2xl font-semibold mb-4">2. Refund Procedure</h2>
      <ul className="list-disc list-inside space-y-2 mb-6">
        <li>
      ...
      <h2 className="text-2xl font-semibold mb-4">3. Timely Reporting Requirement</h2>
      <p className="mb-6">
      ...
      <h2 className="text-2xl font-semibold mb-4">4. Policy Acknowledgement</h2>
      <p className="mb-6">
