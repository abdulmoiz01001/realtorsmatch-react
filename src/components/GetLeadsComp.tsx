...
const GetLeadsComp = () => {
  return (
    <>
       <div className="w-full bg-black text-white py-20 px-4 flex justify-center items-center">
        <div className="text-center max-w-3xl">
          ...
          <button className="bg-[rgb(255,70,85)] hover:bg-[rgb(230,60,75)] text-white px-8 py-4 rounded-full text-base font-semibold transition duration-300">
